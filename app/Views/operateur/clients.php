...
<div class="container-fluid px-4 my-4">
    <div class="d-flex align-items-center gap-2 mb-4">
        ...
        <h3 class="mb-0 fw-bold text-operator"><i class="bi bi-people-fill me-2"></i>Mes Clients</h3>
    </div>
    ...
    <div class="card operator-card">
        <div class="card-header operator-card-header text-white py-3">
            <div class="d-flex align-items-center justify-content-between">
                <h5 class="mb-0">
                    ...
                    <span class="badge bg-white text-operator ms-2"><?= esc($operateur['prefixe_operateur']) ?></span>
                </h5>
        ...
        <div class="card-body p-0">
            <?php if (empty($clients)): ?>
                <p class="text-muted text-center py-4">Aucun client pour l'instant.</p>
            <?php else: ?>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tfoot class="table-light fw-bold">
                            <tr>
                                ...
                                <td class="text-success"><?= number_format($total_soldes, 0, ',', ' ') ?> Ar</td>
                                <td></td>
                            </tr>
                        </tfoot>
                    </table>
